#### AI Integration in Node.js Projects

### Learning Objectives

- Understanding what AI Infrastructure is available that can be utlised in the project
- Ollama - download - models pull and use 
- Gemini API keys and Integration with Node
- Creating Resume Generator Project
