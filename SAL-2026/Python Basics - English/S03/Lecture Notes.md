...
![Why programs need loops — dosa tiffin centre repeating plate preparation and temple prasad counter serving each person in queue, one instruction repeating for many tasks](https://s13n-curr-images-bucket.s3.ap-south-1.amazonaws.com/sal-2026/python-basics-english/s03/s03-01-loops-repetition-dosa-prasad.png?v=20260920)
...
![Increment and decrement — apartment lift floor numbers going up (+1) and rocket launch countdown going down (-1)](https://s13n-curr-images-bucket.s3.ap-south-1.amazonaws.com/sal-2026/python-basics-english/s03/s03-02-increment-decrement-lift-countdown.png?v=20260920)
...
![while vs for loop types — pressure cooker wait until condition changes vs fixed thali menu with 5 numbered items](https://s13n-curr-images-bucket.s3.ap-south-1.amazonaws.com/sal-2026/python-basics-english/s03/s03-03-while-vs-for-loop-types.png?v=20260920)
...
![while loop start stop update — race track with start count=1, condition count<=5, update count+1, and traffic signal wait-while-red analogy](https://s13n-curr-images-bucket.s3.ap-south-1.amazonaws.com/sal-2026/python-basics-english/s03/s03-04-while-loop-start-stop-update.png?v=20260920)
...
![Infinite loop warning — fan spinning endlessly, screen repeating same output, checklist for start condition update and direction](https://s13n-curr-images-bucket.s3.ap-south-1.amazonaws.com/sal-2026/python-basics-english/s03/s03-05-infinite-loop-warning.png?v=20260920)
...
![for loop with range — city bus conductor calling stop numbers 1 to 4 and fare calculated per km using for loop over range](https://s13n-curr-images-bucket.s3.ap-south-1.amazonaws.com/sal-2026/python-basics-english/s03/s03-06-for-loop-range-bus-stops.png?v=20260920)
...
![range() three forms — range(5), range(2,7), range(0,10,2) number lines with stop-before rule, reverse countdown, and cricket 6-ball over example](https://s13n-curr-images-bucket.s3.ap-south-1.amazonaws.com/sal-2026/python-basics-english/s03/s03-07-range-function-three-forms.png?v=20260920)
...
![Factorial calculation — 5 books arrangement showing 5×4×3×2×1=120 step chain and accumulator result growing 1→2→6→24→120](https://s13n-curr-images-bucket.s3.ap-south-1.amazonaws.com/sal-2026/python-basics-english/s03/s03-08-factorial-calculation.png?v=20260920)
