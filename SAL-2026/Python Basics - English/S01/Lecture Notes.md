...
![Manual hotel billing with long queues and paper bills vs digital billing system — Sri Ganesh Hotel example showing faster service and sales tracking](https://s13n-curr-images-bucket.s3.ap-south-1.amazonaws.com/sal-2026/python-basics-english/s01/s01-01-hotel-billing-programming-need.png?v=20260920)
...
- Computers do not understand human languages like English or Hindi directly — they only understand **binary** (0s and 1s) at the deepest level.
...
|----------------|----------------------|
| Flexible — "That's wonderful" can mean many things depending on tone | Strict — every instruction must be exact and unambiguous |
...
- You write code keywords in English (`print`, `if`, `else`), but you can store any language text inside quotes: `name = "Hello"`.
...
- **"Will the computer understand English?"** — You write code using English keywords (`print`, `if`, `else`), and you can also store everyday English text inside quotes.
...
![Input-Process-Output flow — bus distance and rate go in, multiplication happens in the middle, printed fare receipt comes out (Shyam Travels)](https://s13n-curr-images-bucket.s3.ap-south-1.amazonaws.com/sal-2026/python-basics-english/s01/s01-02-input-process-output.png?v=20260920)
...
![Why Python for beginners — readable syntax, online compilers to start, AI/ML and data analytics, backend and automation use cases](https://s13n-curr-images-bucket.s3.ap-south-1.amazonaws.com/sal-2026/python-basics-english/s01/s01-03-python-beginner-friendly.png?v=20260920)
...
![Python syntax, comments, and naming — case-sensitive print, hash comments ignored by Python, snake_case for variables and PascalCase for class names](https://s13n-curr-images-bucket.s3.ap-south-1.amazonaws.com/sal-2026/python-basics-english/s01/s01-06-syntax-comments-naming.png?v=20260920)
...
![Variables as labelled boxes — age, name, balance, and city stored in named containers; balance updates when you spend money](https://s13n-curr-images-bucket.s3.ap-south-1.amazonaws.com/sal-2026/python-basics-english/s01/s01-04-variables-labelled-boxes.png?v=20260920)
...
| **String** | `str` | Text — always written in quotes | `"Hello"`, `'Bengaluru'`, `"Welcome"` |
| **Boolean** | `bool` | True or False values | `True`, `False` |

![Core Python data types — int for whole numbers, float for decimals, str for text, bool for True/False; type conversion turns strings into numbers for maths](https://s13n-curr-images-bucket.s3.ap-south-1.amazonaws.com/sal-2026/python-basics-english/s01/s01-05-data-types-overview.png?v=20260920)
